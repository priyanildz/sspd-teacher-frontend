...
class ExamAttendanceScreen extends StatefulWidget {
  ...
  ExamAttendanceScreen({super.key, required this.subject});
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Text("Exam: ${widget.subject}", style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ],
            ),
            const SizedBox(height: 8),
            Row(
        ...
        children: [
          ...
          Expanded(
            child: TextField(
              ...
              decoration: const InputDecoration(border: InputBorder.none, hintText: "Search Student"),
            ),
          ),
        ],
      ),
